            ...
            <body className="font-sans font-[450] antialiased">
                <ThemeProvider>
                    ...
                    <div className="relative flex min-h-[calc(100vh-4rem)]">
                        <aside className="sticky top-16 hidden h-[calc(100vh-4rem)] w-64 shrink-0 overflow-y-auto border-r border-zinc-200 px-3 py-5 lg:block dark:border-zinc-800/80">
