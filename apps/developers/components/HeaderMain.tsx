...
import Logo from "@prismio/ui/components/Logo"
...
export default function HeaderMain() {
    ...
    return (
        <>
            <header className="sticky top-0 z-[80] border-b border-zinc-200/80 bg-white/90 backdrop-blur-xl dark:border-white/10 dark:bg-[#0b0b0d]/65">
                <div className="flex items-center px-5 sm:px-8 md:px-10 h-17">
