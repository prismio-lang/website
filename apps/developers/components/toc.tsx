...
export const DocsToc: FC<DocsTocProps> = ({ headings }) => {
    ...
    return (
        <nav aria-label="Table of contents" className="relative h-full text-[0.8125rem]">
            <p className="mb-4 text-[0.7rem] font-semibold uppercase tracking-[0.08em] text-zinc-600 dark:text-zinc-400">
                On this page
            </p>
            ...
            <div className="relative border-l border-zinc-200 pl-4 dark:border-zinc-800">
                ...
                <span
                    className="absolute -left-px w-0.5 rounded-full bg-violet-600 transition-all duration-200 ease-out dark:bg-violet-400"
                    style={{
